document.addEventListener('DOMContentLoaded',function(evt){sliderify(document.querySelector('.services'));sliderify(document.querySelector('.promo'));popuppify(document.body,{animation:{fadeInClasses:['animation-fade-in'],fadeOutClasses:['animation-fade-out'],animationDuration:0.1},memorizeFormInputsValues:!0});let uglyRangeBlock=document.querySelector('.form-filter-input-range-pretty');let prettyRangeBlock=document.querySelector('.form-filter-input-range-ugly');if(uglyRangeBlock&&prettyRangeBlock){uglyRangeBlock.classList.toggle('visually-hidden');prettyRangeBlock.classList.toggle('none')}});function popuppify(rootElement=document.body,options={}){const POPUP_ROOT_CLS='js-popuppify-popup';const POPUP_OPEN_CLS='js-popuppify-open';const POPUP_CLOSE_CLS='js-popuppify-close';const POPUP_OVERLAY_CLS='js-popuppify-overlay';const DOT='.';if(!rootElement)
